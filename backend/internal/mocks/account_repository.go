...
func (_m *AccountRepository) CreateAccount(_a0 dbmodels.Account) (map[string]interface{}, error) {
	ret := _m.Called(_a0)
...
func (_c *AccountRepository_CreateAccount_Call) Return(_a0 map[string]interface{}, _a1 error) *AccountRepository_CreateAccount_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *AccountRepository_CreateAccount_Call) RunAndReturn(run func(dbmodels.Account) (map[string]interface{}, error)) *AccountRepository_CreateAccount_Call {
	_c.Call.Return(run)
	return _c
}
